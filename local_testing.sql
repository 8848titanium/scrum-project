...
# 插入测试数据
INSERT INTO student(`student_id`, `student_name`, `student_password`, `student_email`) VALUES ("1", "zjq", "123", "123@outlook.com");
INSERT INTO lecturer(`lecturer_id`, `lecturer_name`, `lecturer_password`, `lecturer_email`) VALUES ("1", "Michael", "456", "777@outlook.com");

INSERT INTO quiz(`quiz_id`, `lecturer_id`, `quiz_PIN`) VALUES (1,1,12345678);
INSERT INTO quiz(`quiz_id`, `lecturer_id`, `quiz_PIN`) VALUES (2,1,87654321);
INSERT INTO question(`question_id`, `quiz_id`, `question`, `type`, `A`, `B`, `C`, `D`, `answer`) VALUES (1,1,"MonoMCQ?",0,"dasdas","dsadas","dasdsa","dasda","B");
INSERT INTO question(`question_id`, `quiz_id`, `question`, `type`, `A`, `B`, `C`, `D`, `answer`) VALUES (2,2,"MCQ?",1,"vfdvdf","vcxvzcx","sdafsa","fdasfsa","AC");
INSERT INTO question(`question_id`, `quiz_id`, `question`, `type`, `A`, `B`, `C`, `D`, `answer`) VALUES (3,1,"fill?",2,NULL,NULL,NULL,NULL,"Filled");
